...
class DocumentsManager {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (this.documents.length === 0) {
          list.innerHTML = '<div class="empty-state"><div class="empty-icon">📄</div><p>No documents yet</p><p class="empty-hint">Documents generated by sub-agents will appear here</p></div>';
        } else {
          this.applyFilters();
        }
      ...
      // Show empty state on error (API not available)
      list.innerHTML = '<div class="empty-state"><div class="empty-icon">📄</div><p>No documents yet</p><p class="empty-hint">Documents generated by sub-agents will appear here</p></div>';
    }
  }
  ...
  buildDocumentItem(doc, index) {
    ...
    const categoryLabel = this.formatCategoryLabel(doc.category);
    ...
    return `
      <div class="document-item ${isActive}" data-index="${index}">
        ...
        <div class="doc-item-meta">
          ...
          <span class="doc-item-category category-${doc.category}">${categoryLabel}</span>
        </div>
      </div>
    `;
  }
